				...
				<div align="center" id="searchNotice">
					<table>
						<colgroup>
							...
							<tr>
								<td class="ac">작성일</td>
								<td><%=svo.getBs_insertdate().substring(0,10) %></td>
							</tr>
							<tr>
								<td class="ac">제목</td>
							...
							<tr class="ctr">
								<td class="ac">내용</td>
								<td colspan="3"><%=svo.getBs_content() %></td>
							</tr>
<%
...
%>
						...
						<tr class="ctr">
							<td class="ac">첨부사진</td>
							<td colspan="3"><img src="../<%=svo.getBs_image() %>" border=0></td>					
							<td><input type="button" id="fileDown" name="fileDown" value="이미지 다운로드"></td>
						</tr>
<%
						}
%>
...
%>
					...
					<div align="center">
						<input align="right" type="button" value="수정" class="but" id="updateSuggestion" name="updateSuggestion"/>
						<input align="right" type="button" value="삭제" class="but" id="deleteSuggestion" name="deleteSuggestion"/>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
